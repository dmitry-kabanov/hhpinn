#!/usr/bin/env python
# %% [markdown]
# # 07-2021-09-27 Taylor-Green 2D vortex with 50 measurements
#
# I use training dataset with 50 measurements to check if the model
# can be trained to predict well.
#
# ## Imports
...
# ## Load data
#
# We use Taylor--Green vortex with 50 measurements and random seed 10 for
