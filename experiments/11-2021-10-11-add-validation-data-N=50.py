# %% [markdown]
# # 11-2021-10-11 Add validation data to training, N=50
#
# I am interested in using ideas from the paper
# L. N. Smith. *A disciplined approach to neural network hyper-parameters:
# Part I*, arXiv:1803.09820v2
#
# In that paper, the author recommends to analyze behavior of validation loss
# during training.
# In this experiment I implement it and check the loss on several models.
# This is a repeat of the previous experiment, but here the number of training
# measurements is 50.
