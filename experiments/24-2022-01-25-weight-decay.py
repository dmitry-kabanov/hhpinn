# %% [markdown]
# # 24-2022-01-25 Two-layer network with weight decay
#
# I consider here a neural network with two hidden layers with varying
# weight decay parameter to see how it affects generalization.
...
# hidden-layers, optimizer, weight decay.
Config = namedtuple("Config", ["hl", "opt", "l2"])
CONFIGS = [
