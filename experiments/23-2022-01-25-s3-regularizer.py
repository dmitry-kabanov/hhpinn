# %% [markdown]
# # 23-2022-01-25 Two-layer network with Sobolev3 regularizer
#
# I consider here a neural network with two hidden layers.
# I vary the amount of regularization on third derivatives (Sobolev3).
