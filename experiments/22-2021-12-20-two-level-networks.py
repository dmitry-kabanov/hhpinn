# %% [markdown]
# # 22-2021-12-20 Two-layer networks
#
# I consider here a set of networks with two hidden layers instead of one
# with different number of neurons in each layer.
...
CONFIGS = [
    ...
    Config([150, 100], "adam", 1e-2),
    Config([200, 100], "adam", 1e-2),
    Config([100, 100], "adam", 1e-2),
    Config([150, 150], "adam", 1e-2),
    Config([200, 200], "adam", 1e-2),
]
